...
import se.ecutb.cai.data.DataStorage;
import se.ecutb.cai.model.Gender;
import se.ecutb.cai.model.Person;
...
public class App {
    ...
    public static void exercise1(String message) {
        //Find everyone that has firstName: “Erik” using findMany()
        System.out.println(message + dataStorage.findMany(person -> person.getFirstName().equalsIgnoreCase("Erik")));
    }

    public static void exercise2(String message) {
        //Find all females in the collection using findMany().
        System.out.println(message + dataStorage.findMany(person -> person.getGender().equals(Gender.FEMALE)));
    }

    public static void exercise3(String message) {
        //Find all who are born after (and including) 2000-01-01 using findMany().
        System.out.println(message + dataStorage.findMany(person -> person.getBirthDate().isAfter(LocalDate.parse("1999-12-31"))));
    }

    public static void exercise4(String message) {
        //Find the Person that has an id of 123 using findOne().
        System.out.println(message + dataStorage.findOne(person -> person.getId() == 123));
    }

    public static void exercise5(String message) {
        //Find the Person that has an id of 456 and convert to String with following content:  “Name: Nisse Nilsson born 1999-09-09”. Use findOneAndMapToString()
        Function<Person, String> findToString = person -> "Name: " + person.getFirstName() + " born: " + person.getBirthDate();
        System.out.println(message + dataStorage.findOneAndMapToString(person -> person.getId() == 456, findToString));
    }

    public static void exercise6(String message) {
        //Find all male people whose names start with “E” and convert each to a String using findManyAndMapEachToString()
        System.out.println(message);
        Predicate<Person> findE = person -> person.getFirstName().startsWith("E") && person.getGender() == Gender.MALE;
        dataStorage.findManyAndMapEachToString(findE, Person::toString).forEach(System.out::println);

    }

    public static void exercise7(String message) {
        //Find all people who are below age of 10 and convert them to a String like this: “Olle Svensson 9 years”. Use findManyAndMapEachToString() method.
        System.out.println(message);
        Function<Person, String> ageBelow10Map = person -> person.getFirstName() +
                " " + person.getLastName() + " " + Period.between(person.getBirthDate(), LocalDate.now()).getYears();

        Predicate<Person> getBelow10 = person -> Period.between(person.getBirthDate(), LocalDate.now()).getYears() < 10;
        dataStorage.findManyAndMapEachToString(getBelow10, ageBelow10Map).forEach(System.out::println);
    }

    public static void exercise8(String message) {
        //Using findAndDo() print out all people with firstName “Ulf”.
        System.out.println(message);
    ...
    public static void exercise9(String message) {
        //Using findAndDo() print out everyone who have their lastName contain their firstName.
        System.out.println(message);
        Predicate<Person> containLastAndFirst = person -> person.getLastName().contains(person.getFirstName());
        dataStorage.findAndDo(containLastAndFirst, System.out::println);

    }

    public static void exercise10(String message) {
        //Using findAndDo() print out the firstName and lastName of everyone whose firstName is a palindrome.
        System.out.println(message);
        Predicate<Person> findPalindrome = person -> new StringBuilder(person.getFirstName()).reverse().toString().equalsIgnoreCase(person.getFirstName());
        dataStorage.findAndDo(findPalindrome, System.out::println);

    }

    public static void exercise11(String message) {
        // Using findAndSort() find everyone whose firstName starts with A sorted by birthDate.
        System.out.println(message);
        Predicate<Person> sortNameWithA = person -> person.getFirstName().startsWith("A");
        Comparator<Person> sortBirth = Comparator.comparing(Person::getBirthDate);
        dataStorage.findAndSort(sortNameWithA, sortBirth).forEach(System.out::println);
    }

    public static void exercise12(String message) {
        //Using findAndSort() find everyone born before 1950 sorted reversed by latest to earliest.
        System.out.println(message);
        ...
        dataStorage.findAndSort(bornBefore1950, latestToEarliest).forEach(System.out::println);

    }

    public static void exercise13(String message) {
        //Using findAndSort() find everyone sorted in following order: lastName > firstName > birthDate.
        System.out.println(message);
        Comparator<Person> findAll = Comparator.comparing(Person::getLastName).thenComparing(Person::getFirstName).thenComparing(Person::getLastName);

        dataStorage.findAndSort(findAll).forEach(System.out::println);
    }
}
